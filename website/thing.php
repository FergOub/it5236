...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
	...
	$thing = json_decode($app->getThing($thingid, $errors));
	...
	if (sizeof($errors) == 0) {
		...
		if (isset($thing)) {
			$comments = json_decode($app->getComments($thing->thingid, $errors));
		}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$result = json_decode($app->addComment($text, $thingid, $attachment, $errors));
